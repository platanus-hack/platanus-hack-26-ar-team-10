...
Future file: `yield.agent-pack.yaml`

Agent packs package approved profiles, skills, MCPs, guidelines, and playbooks into native output files for target agents. They are deployment manifests, not independent policy authorities.
