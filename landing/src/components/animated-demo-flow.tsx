...
function toneClass(tone: string) {
  if (tone === "rewrite") {
    return "border-[rgba(var(--signal-bright-rgb),0.34)] bg-[rgba(var(--signal-bright-rgb),0.06)] text-[var(--signal-bright)]";
  }
  if (tone === "native") {
    return "border-[rgba(var(--signal-bright-rgb),0.18)] bg-[rgba(var(--signal-bright-rgb),0.045)] text-zinc-100";
  }
  return "border-[rgba(var(--signal-muted-rgb),0.28)] bg-[rgba(var(--signal-muted-rgb),0.07)] text-zinc-200";
}
    ...
    >
      <div className="rounded-lg border border-white/10 bg-white/[0.04] p-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] sm:p-3">
        <div className="relative overflow-hidden rounded-md border border-white/10 bg-[#151517]">
          ...
          <div className="grid grid-cols-[1fr_auto] border-b border-white/10 px-3 py-2.5 font-mono text-xs text-zinc-500 sm:px-4 sm:py-3">
            <span>verdicts</span>
            <span className="hidden bg-[linear-gradient(90deg,var(--signal-bright),var(--signal-muted))] bg-clip-text text-transparent sm:inline">
              allow / block
            </span>
          </div>
      ...
      <div className="hidden rounded-lg border border-white/10 bg-white/[0.04] p-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] sm:p-3 lg:block">
        <div className="relative grid min-h-full overflow-hidden rounded-md border border-white/10 bg-[#f4f3ef] text-zinc-950">
          <div className="absolute inset-x-0 top-0 h-px bg-[linear-gradient(90deg,transparent,var(--signal-bright),var(--signal-muted),transparent)]" />
