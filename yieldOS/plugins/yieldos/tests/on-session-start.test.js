...
test('pentest auto-launch is opt-in only', () => {
  assert.equal(sessionStart.pentestAutoLaunchEnabled({}), false);
  assert.equal(sessionStart.pentestAutoLaunchEnabled({ YIELDOS_PENTEST: 'off' }), false);
