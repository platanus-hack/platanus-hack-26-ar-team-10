...
// the pentest-loop auto-launcher: idempotent, survives session end, dead
// PIDs are auto-cleared.
...
function launch(projectRoot, opts = {}) {
  ...
  const child = spawn(process.execPath, [serverEntry, projectRoot], {
    cwd: projectRoot,
...
module.exports = { launch, stop, status, isAlreadyRunning, lockPath, logPath, DEFAULT_PORT };
